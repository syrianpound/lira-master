...
// Copyright (c) 2014-2015 The lira developers
// Copyright (c) 2015 The Lira developers
...
void ThreadSecureMsg(void* parg)
{
    ...
    RenameThread("lira-smsg"); // Make this thread recognisable
...
void ThreadSecureMsgPow(void* parg)
{
    ...
    RenameThread("lira-smsg-pow"); // Make this thread recognisable
