...
int64_t GetProofOfWorkReward(int nHeight, int64_t nFees, uint256 prevHash)
{
    ...
    int rand = generateMTRandom(seed, 1200);
                                                                                   
	if (nHeight == 2)
        nSubsidy = 4000000 * COIN; //lira premine
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Lira", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Lira";
        CTransaction txNew;
        txNew.nTime = 1500162896;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1500162896;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 1122818 : 1122818;
...
//        assert(block.hashMerkleRoot == uint256("0x"));
        assert(block.hashMerkleRoot == uint256("0x5704d63cf1054ce34e614c4584ffdb7d8fa360e5a9b4ba972924fb4eb771c1c6"));
