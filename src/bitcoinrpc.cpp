...
{
    return GetBoolArg("-testnet", false) ? 19897 : 19889;
}
...
Value stop(const Array& params, bool fHelp)
{
    if (fHelp || params.size() > 1)
        throw runtime_error(
            ...
            "Stop Lira server (and possibly override the detachdb config value).");
